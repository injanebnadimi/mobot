...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            ...
                            <p style="font-size: 15px;">ارتباط با ما : <a style="text-decoration: none; color: #75AC9D;" href="https://T.me/Mobot_Platform">  تلگرام </a></p>
...
const showTypingAnimation = () => {
    ...
    const html = `<div class="chat-content">
                    <div class="chat-details">
                        <img src="images/mobot.jpg" alt="chatbot-img">
...
deleteButton.addEventListener("click", () => {
    ...
    if(confirm("مطمئنی میخوای چت رو پاک کنی؟!")) {
